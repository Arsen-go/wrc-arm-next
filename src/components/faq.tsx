...
const FAQS = [
  ...
  {
    title:
      "3. What steps is your company taking to combat gender-based violence?",
  ...
  {
    title:
      "5. How can individuals support your company's women's rights initiatives?",
...
export function Faq({ locales }: any) {
