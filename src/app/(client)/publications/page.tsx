...
const content = [
  ...
  },
  {
    ...
    desc: "This is a comprehensive report of the WRC’s activities in 2022. All the activities, projects, initiatives are presented by teams.",
  ...
  },
  {
    ...
    desc: "This factsheet is prepared by the Advocacy and Policy Development team of the Women Resource Center NGO. It is intended for Government agencies and Civil Society representatives who carry out advocacy activities in this field. The factsheet is based on a rights-based and evidence-based approach.",
    date: "2023",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "This is a short annotation of the research on Impact of 2020 Artsakh War and the Post-War Situation on Women’s Basic Rights. This report presents the impact of the war unleashed by Azerbaijan between September and November of 2020 on the women living and/or displaced from Artsakh.",
    date: "2021",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "In the publication, we gathered insights from our members from 16 countries of the region, with a focus put on seven aspects of SRHR.",
    date: "2021",
    readMoreLink:
      "https://womenofarmenia.org/wp-content/uploads/2021/06/Artsakh-war-and-womens-rights.pdf",
  },
  {
    ...
    desc: "This joint UPR stakeholder report (2020) was developed by the “Advocates for Reproductive Health and Rights” network initiated by the Women’s Resource Center.",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "The on-line survey in a form of formative assessment was conducted among the women to reveal their experiences in sexual and reproductive health services during the pandemic. The main tool of the survey was a standardized questionnaire.",
    date: "2020",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "In this small-scale quantitative study, a group of researchers attempted to understand what people think of women’s organizations in Armenia, and what the roles and missions are of these organizations in politics and everyday life.",
    date: "2019",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "The report has been developed considering the diverse views and experiences of women from rural areas, with disabilities, LBT women, Yezidis and women that are HIV positive.",
    date: "2019",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "Data for this report (2019) was collected via an online questionnaire was then analyzed through quantitative and qualitative measures and related to the recent literature in the field.",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "The aim of this study (2019) was to examine the key perceptions of morality in Armenian society today, their effect on behavior, from both individual and societal points of view, and reciprocities with the issue of sexuality.",
    readMoreLink:
  ...
  },
  {
    ...
    desc: "In this collection of articles (2016) various manifestations of gender discrimination on different levels and in different areas in Armenian society is presented.",
    readMoreLink:
